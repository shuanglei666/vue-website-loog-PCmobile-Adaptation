<template>
  ...
  <div class="Mytitle">
    ...
    <div class="Mytitle_pc">
      <div class="main_box">
        <div class="logo">
          <img src="../../assets/images2/LOOG.png">
        </div>
        <!-- <div class="list_box">
        ...
        <div class="iconList">
          ...
          <div class="languag">
            <div :class="flag? 'langSpan1' : 'langSpan2'" @click="getLang('zh')">{{$t('Home2.Mytitle.CN')}}</div>
            <span> / </span>
...
export default {
  ...
  methods: {
    jump (index) {
      // this.num = index; // border 改为动态滚动切换border监听滚轮window.addEventListener
  ...
  mounted () {
    ...
    //     window.pageYOffset;
    //   if (this.top >= 0 && this.top < 603) {
    //     this.num = 0 // 
    //   } if (this.top >= 603 && this.top < 1548) {
    //     this.num = 1
    //   } if (this.top >= 1548 && this.top < 2413) {
    //     this.num = 2
    //   } if (this.top >= 2413 && this.top < 3116) {
    //     this.num = 3
    //   } if (this.top >= 3116 && this.top < 3671) {
    //     this.num = 4
    //   } if (this.top >= 3671 && this.top < 4488) {
    //     this.num = 5
    //   } if (this.top >= 4488) {
    //     this.num = 6
    //   }
    //   console.log(this.top, '位置');
    // });
    ...
    window.addEventListener("scroll", () => {
      this.top =
        ...
        document.body.scrollTop ||
        window.pageYOffset;
      if (this.top >= 0 && this.top < 600) {
        this.num = 0 
      } if (this.top >= 600 && this.top < 1530) {
        this.num = 1
      } if (this.top >= 1530 && this.top < 2400) {
        this.num = 2
      } if (this.top >= 2400 && this.top < 3100) {
        this.num = 3
      } if (this.top >= 3100 && this.top < 3600) {
        this.num = 4
      } if (this.top >= 3600 && this.top < 4430) {
        this.num = 5
      } if (this.top >= 4430) {
        this.num = 6
      }
  ...
  .main_media_box {
    ...
    .main_media {
      ...
      .main_media_left {
        ...
        box-sizing: content-box;
        margin-right: 30px;
        background-image: url(../../assets/images2/LOOG.png);
